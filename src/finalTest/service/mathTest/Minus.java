...
public class Minus implements OperatorState{
    ...
    public String getStatement(MathTest mathTest) {
        ...
        sb.append(target_a)
                ...
                .append("(을/를) ").append(x)
                .append("개 가지고 있습니다.\n");
        sb.append(target_b).append("(은/는) ").append(target_a).append("에게 ").append(interest).append("(을/를) ")
                .append(y).append("개를 주었습니다.\n");
        sb.append(target_a).append("에게 몇 개의 ").append(interest).append("(이/가) 남았습니까?\n");
